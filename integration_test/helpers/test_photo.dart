...
/// Minimalny plik JPEG (1x1 px) do testów uploadu zdjęć.
Future<File> createTestPhotoFile() async {
  final file = File(
    '${Directory.systemTemp.path}/city_issues_integration_test.jpg',
  );
  await file.writeAsBytes(const <int>[
    ...
    0xDB, 0x20, 0xA8, 0xF1, 0x5E, 0x7A, 0xFF, 0xD9,
  ]);
  return file;
}
